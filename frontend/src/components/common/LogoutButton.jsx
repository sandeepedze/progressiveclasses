    ...
    return (
        <>
            <TouchableOpacity
                ...
                className="flex-row items-center justify-center bg-red-50 p-4 rounded-md mt-6 border border-red-100 active:bg-red-100"
                style={{
                    shadowColor: '#DC2626',
            ...
            <Modal visible={visible} transparent animationType="fade">
                <View className="flex-1 bg-black/50 items-center justify-center p-4">
                    <View className="bg-white rounded-md p-6 w-full max-w-sm shadow-xl">
                        ...
                        <View className="flex-row gap-3">
                            <TouchableOpacity
                                ...
                                className="flex-1 bg-slate-100 py-3 rounded-md items-center"
                            >
                                <Text className="text-slate-700 font-bold">Cancel</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                onPress={handleConfirm}
                                className="flex-1 bg-red-600 py-3 rounded-md items-center"
                            >
